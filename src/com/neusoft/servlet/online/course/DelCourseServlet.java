...
//			st.executeUpdate(sql);
			String sqldelkb01="delete from COUR_KB01 where cid in("+dids+")";
			st.executeUpdate(sqldelkb01);
			
			String sqldel="delete from course where id in("+dids+")";
			st.executeUpdate(sqldel);
			con.commit();
			request.getRequestDispatcher("/course/SelCourse.do?page="+request.getParameter("_current")).forward(request, response);
