    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
		...
		<td height="35" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;padding-left: 8px;" >
		  	<input type="text" name="oname" id="oname" value="${operator.name}" style="width: 80px"/>
		</td>
      </tr>
      <tr>
        <td height="35" width="10%" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;padding-left: 8px;font-weight: bold;color: #3B6375;" >
      ...
      <tr>
		...
		<td height="35" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;padding-left: 8px;" >
    	   <input type="text" style="width: 30px;" name="age" value="${operator.age}"/> 岁
		</td>
      </tr>
      ...
      <tr>
		...
		<td height="35" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;padding-left: 8px;" >
    	   <input type="text" name="tel" value="${operator.tel}"/>
		</td>
      </tr>
     <tr>
		...
		<td height="35" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left; padding-left: 8px;">
    	   <c:if test="${operator.xl==1 }">
    	   	   <input type="radio" name="whcd" value='1' checked="checked"/>小学
	    	   <input type="radio" name="whcd" value='2'/>初中
	    	   <input type="radio" name="whcd" value='3'/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4'/>大学专科
	    	   <input type="radio" name="whcd" value='5'/>大学本科
	    	   <input type="radio" name="whcd" value='6'/>硕士研究生及以上
    	   </c:if>
    	   <c:if test="${operator.xl==2 }">
    	   	   <input type="radio" name="whcd" value='1'/>小学
	    	   <input type="radio" name="whcd" value='2' checked="checked"/>初中
	    	   <input type="radio" name="whcd" value='3'/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4'/>大学专科
	    	   <input type="radio" name="whcd" value='5'/>大学本科
	    	   <input type="radio" name="whcd" value='6'/>硕士研究生及以上
    	   ...
    	   <c:if test="${operator.xl==3 }">
    	   	   <input type="radio" name="whcd" value='1'/>小学
	    	   <input type="radio" name="whcd" value='2'/>初中
	    	   <input type="radio" name="whcd" value='3' checked="checked"/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4'/>大学专科
	    	   <input type="radio" name="whcd" value='5'/>大学本科
	    	   <input type="radio" name="whcd" value='6'/>硕士研究生及以上
    	   </c:if>
    	   <c:if test="${operator.xl==4 }">
	    	   ...
	    	   <input type="radio" name="whcd" value='2'/>初中
	    	   <input type="radio" name="whcd" value='3'/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4' checked="checked"/>大学专科
	    	   <input type="radio" name="whcd" value='5'/>大学本科
	    	   <input type="radio" name="whcd" value='6'/>硕士研究生及以上
    	   </c:if>
    	   <c:if test="${operator.xl==5}">
	    	   ...
	    	   <input type="radio" name="whcd" value='3'/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4'/>大学专科
	    	   <input type="radio" name="whcd" value='5' checked="checked"/>大学本科
	    	   <input type="radio" name="whcd" value='6'/>硕士研究生及以上
    	   </c:if>
    	   <c:if test="${operator.xl==6 }">
	    	   ...
	    	   <input type="radio" name="whcd" value='4'/>大学专科
	    	   <input type="radio" name="whcd" value='5'/>大学本科
	    	   <input type="radio" name="whcd" value='6'  checked="checked"/>硕士研究生及以上
    	   </c:if>
    	   <c:if test="${operator.xl==null }">
    	   	   <input type="radio" name="whcd" value='1'/>小学
	    	   <input type="radio" name="whcd" value='2'/>初中
	    	   <input type="radio" name="whcd" value='3'/>高中（中职学校、技校、普通高中学校）
	    	   <input type="radio" name="whcd" value='4'/>大学专科
    	   ...
    	   <input type="hidden" name="xl" id="xl" value="${operator.xl}"/>
      ...
      <tr>
		...
		<td height="100" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left; padding-left: 8px;">
    	   <FCK:editor instanceName="yq" height="400px" >
