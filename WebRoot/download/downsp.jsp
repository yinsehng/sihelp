          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"><a href="<%=basePath%>right.jsp"><strong>系统首页</strong></a>--><font style="font-weight: normal;">操作视频下载</font></span></td>
              </tr>
            </table></td>
      ...
      <tr>
        <td height="80" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;" colspan="2">
          <div style="width: 30%;float: left;padding:10px 0px 10px 30px;"> 
			 <a href="<%=basePath%>downfile/vmz.rar" ><img src="<%=basePath %>images/mz.gif" style="float: left; margin-top: 30px;" border="0"/></a>
		   </div>
		   <div style="width: 30%;float: left; margin-top: 10px;">
		   	 <a href="<%=basePath%>downfile/vzy.rar" ><img src="<%=basePath %>images/zy.gif" style="float: left; margin-top: 30px;" border="0"/></a>
		   </div>
		   <div style="width: 30%;float: left; margin-top: 10px;"> 
		     <div style="float: left;width: 20%">
		     <a href="<%=basePath%>downfile/vinf.rar" ><img src="<%=basePath %>images/inf.gif" style="float: left; margin-top: 30px;" border="0"/></a>
		     </div>
		   </div>
		   <div style="float: left;margin-top: 25px;padding-left:10px;width: 75%;font-size: 14px;line-height: 21px;">
		     	<strong>说明：</strong><br/>
		     	如有操作不明白的地方可以下载相应的视频观看学习
		     </div>
		</td>
      </tr>
