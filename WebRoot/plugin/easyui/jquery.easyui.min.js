 ...
 * update by wxy tree-checkbox2->tree-checkbox1 2011-7-5
 */
(function ($) {
	function _1(_2) {
			...
			if (opts.toolbar) {
				...
				for (var i = 0; i < opts.toolbar.length; i++) {
					...
					if (btn == "-") {
						...
						var tool = typeof (btn.href) == "undefined" ? $("<a href=\"javascript:void(0)\"></a>") : $("<a href=\"" + btn.href + "\"></a>");
	...
	function init(_1c6) {
		...
		function _1c7(dir) {
			...
			if (pp.attr("split") == "true") {
				...
				_1c9.resizable({handles:"", onStartResize:function (e) {//handles:_1ca->"" can't resize
					_1bd = true;
...
(function ($) {
	...
	$.messager = {show:function (_20a) {
		var opts = $.extend({showType:"slide", showSpeed:600, width:250, height:150, msg:"", title:"", timeout:4000}, _20a || {});
		var win = $("<div class=\"messager-body\"></div>").html(opts.msg).appendTo("body");
		win.window({title:opts.title, width:opts.width, height:opts.height, collapsible:false, minimizable:false, maximizable:false, shadow:false, draggable:false, resizable:false, closed:true, onBeforeOpen:function () {
			show(this, opts.showType, opts.showSpeed, opts.timeout);
			return false;
		}, onBeforeClose:function () {
			$.ajax({url:"./index/del.action?id=" + $("[name='msgID']").val(), type:"post", dataType:"json", success:function (t) {
				$("[name='msgID']").val("");
			}});//update by wxy
...
(function ($) {
	...
	function _2e7(_2e8) {
		...
		$(".tree-checkbox", tree).unbind(".tree").bind("click.tree", function () {
			if ($(this).hasClass("tree-checkbox0")) {
				...
				if ($(this).hasClass("tree-checkbox1")) {
					...
					if ($(this).hasClass("tree-checkbox1")) {
						$(this).removeClass("tree-checkbox1").addClass("tree-checkbox1");
					}
				}
			}
			_2eb($(this).parent());
		...
		function _2ec(node) {
			...
			_2ed.removeClass("tree-checkbox0 tree-checkbox1 tree-checkbox1");
		...
		function _2eb(node) {
			...
			if (_2ee) {
				...
				ck.removeClass("tree-checkbox0 tree-checkbox1 tree-checkbox1");
				if (_2ef(node)) {
			...
			function _2ef(n) {
				...
				if (ck.hasClass("tree-checkbox0") || ck.hasClass("tree-checkbox1")) {
					return false;
				}
				var b = true;
			...
			function _2f0(n) {
				var ck = n.find(".tree-checkbox");
				if (ck.hasClass("tree-checkbox1") || ck.hasClass("tree-checkbox1")) {
					return false;
				}
				var b = true;
				n.parent().siblings().each(function () {
