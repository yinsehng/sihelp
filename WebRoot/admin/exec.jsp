...
<form action="<%=basePath %>servlet/SelKb01Servlet" method="post" id="sform">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="80" bgcolor="#FFFFFF" class="STYLE6"  style="text-align: left;" colspan="2">
          <div style="width: 30%;float: left;padding:10px 0px 10px 30px;"> 
		   	 <ul>
		   	  <li> 
		   	    定点编号：<input type="text" class="nl" name="akb020" style="width:150px;" value="${akb020 }"/><br/>
		   	  </li>
		   	  <li>
		   	    定点名称：<input type="text" class="nl" name="akb021" style="width:150px;" value="${akb021 }"/>
		   	  </li>
		   	 </ul>
		   </div>
		   <div style="width: 30%;float: left; margin-top: 10px;">
		   	 <input type="submit"  value="查询" style="width: 60px; height: 60px;"/>
		   </div>
		   <div style="width: 30%;float: left; margin-top: 10px;"> 
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <%ArrayList al=(ArrayList)request.getAttribute("kb01");
        Iterator it=al.iterator();
        while(it.hasNext()){
        	Kb01 kb01=(Kb01)it.next();%>
        	
        	<tr onmouseover="moves('<%=kb01.getAkb020()%>')" onmouseout="outs('<%=kb01.getAkb020()%>')" id="t_<%=kb01.getAkb020()%>" >
        		<td height="20" bgcolor="#FFFFFF"><div align="center">
	              <input type="checkbox" name="cid"   value="<%=kb01.akb020 %>"/>
		        </div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getAkb020() %> </div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getAkb021() %> </div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getAae004() %></div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getAae005() %></div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getAae006() %></div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><%=kb01.getCkb162() %></div></td>
		        <td height="22" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><input type="button" onclick="opens('<%=kb01.getAkb020() %>')" value="操作" style="width: 35px; height: 18px;font-size: 10px;border: 1px solid #a8c7ce;color: #204155;text-align: center;"/></div></td>
		    </tr>
